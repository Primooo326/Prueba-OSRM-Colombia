...
-- 5. CONFIGURACIÓN CAR (Automóvil Particular)
function setup()
  return {
    properties = {
      max_speed_for_map_matching      = 180/3.6, -- 180 km/h max
    ...
    turn_penalty              = 7.5, -- Giro estándar
    speed_reduction           = 0.8,
    turn_bias                 = 1.075,
    cardinal_directions       = false,

    -- DIMENSIONES COCHE ESTÁNDAR
    vehicle_height = 2.0, -- Incluyendo barras de techo/SUV
    vehicle_width  = 1.9,
    vehicle_length = 4.8,
    vehicle_weight = 2000, -- 2 Toneladas
    ...
    speeds = Sequence {
      highway = {
        motorway        = 100, -- Ajustado a realidad colombiana/urbana (antes 90/120)
        motorway_link   = 45,
        trunk           = 85,
        trunk_link      = 40,
        primary         = 65,
    ...
    maxspeed_table_default = { urban = 50, rural = 90, trunk = 100, motorway = 120 },
    maxspeed_table = {},
